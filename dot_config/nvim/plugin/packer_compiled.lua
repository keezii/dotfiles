...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/Users/jan/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/jan/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/jan/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
    url = "https://github.com/ellisonleao/gruvbox.nvim"
  },
  harpoon = {
    loaded = true,
    path = "/Users/jan/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  undotree = {
    loaded = true,
    path = "/Users/jan/.local/share/nvim/site/pack/packer/start/undotree",
